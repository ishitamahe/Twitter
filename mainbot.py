...
while True:
    user = api.get_user('IshitaMaheshwa5')
    api.update_profile(name=f'Ishita Maheshwari|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : Ishita Maheshwari|{follower_count(user)} Followers')
